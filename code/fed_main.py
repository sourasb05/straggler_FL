...
def main():
    ...
    if args.user_type == 0:
        ...
        file_name = path_project + '/save/Random_{}_{}_method[{}]_straggler[{}]_iid[{}]_LE[{}]_B[{}]_GE[{}]_adaptive[{}].pkl'. \
    ...
    # selection based computational speed
        ...
        for epoch in range(args.epoch):
            ...
            if flag == 0:
                ...
                if flag + args.adaptiveness <= len(idxs_users):
                    ...
                    print("idxs1 :", len(idxs1))
                    # idxs1 = np.random.choice(range(args.num_users), , replace=False)
        ...
        # Saving the objects train_loss and train_accuracy:
        file_name = path_project + '/save/Fed-MOODS_{}_{}_method[{}]_straggler[{}]_iid[{}]_LE[{}]_B[{}]_GE[{}]_adaptive[{}].pkl'. \
            format(args.dataset, args.model, args.method, args.straggler_frac, args.iid,
                   args.l_epoch, args.l_batch, args.epoch, args.adaptiveness)
